...
(situacion.lenguaje:defsituacion almacen (:etiqueta "Almacen")
  ...
  (vista rejilla :de movimientos :etiqueta "Por proveedor y tipo"
                 :filas proveedor :columnas tipo :muestra cantidad))
...
(definir-prueba alcance-tabla-cruzada
  ...
  (let* ((s (situacion.lenguaje:situacion-llamada "ALMACEN"))
    ...
    (comprobar (eq (n "proveedor") (nucleo:eje-de-filas cruzada)))
    (comprobar (eq (n "tipo") (nucleo:eje-de-columnas cruzada)))
    (comprobar (eq (n "cantidad") (nucleo:lo-que-se-muestra cruzada))))
